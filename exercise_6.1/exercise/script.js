//estados
const cityTotal = ['Acre', 'Alagoas', 'Amapá', 'Amazonas', 'Bahia', 'Ceará', 'Espírito Santo', 'Goiás', 'Maranhão', 'Mato Grosso', 'Mato Grosso do Sul', 'Minas Gerais', 'Pará','Paraíba','Paraná', 'Pernambuco', 'Piauí', 'Rio de Janeiro', 'Rio Grande do Norte', 'Rio Grande do Sul', 'Rondônia', 'Roraima', 'Santa Catarina','São Paulo', 'Sergipe', 'Tocantins', 'Distrito Federal']; 

const cityId = document.getElementById('estado');
for(let index = 0; index < cityTotal.length; index += 1) {
  const createOption = document.createElement('option');
  createOption.innerHTML = cityTotal[index];
  cityId.appendChild(createOption);
}
...
//fonte: https://app.betrybe.com/course/fundamentals/html-forms/solutions
// ---------------------------------------------------------------
// Capiturar o evento de click do botao para cancelar o fluxo aotomatico
// botão 

//  objeto com tudo que sera verificado
let inputs = {
  name: {
    maxLength: 40,
    required: true,
...
// fazer a validação desse jeito - mas entenda a de cima



// function lidaComSubmit(event) {
//   event.preventDefault(); 
...
//   // console.log(name.value) //consigo recuperar o valor
  ...
  // }
// }
// // event guarda as informaçoes do evento (o click)
// // preventDefoult previne o comportamento padrão do botão , nesse caso não valida e envia. So valida.

// window.onload = function () {

//   let button = document.querySelector('.submit-button');
//   button.addEventListener('click', lidaComSubmit)
// }
